...
int do_bootm(struct cmd_tbl *cmdtp, int flag, int argc, char *const argv[])
{
	...
	case IMAGE_FORMAT_ANDROID:
		...
		break;
#endif
/* Polytech patch derived from: https://community.nxp.com/t5/i-MX-Processors/Patch-for-u-boot-imx-Using-FIT-and-HAB-in-bootm-command/m-p/1164472 */
#ifdef CONFIG_FIT
...
#endif
	default:
		printf("do_bootm/B Not valid image format (%d, %p) for Authentication, Please check\n", genimg_get_format((const void *)image_load_addr), image_load_addr);
		return 1;
	}
#endif
#endif
